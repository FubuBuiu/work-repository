...
const SubstanceRegisterPage = () => {
    ...
    return (
        <>
            <h1 className='text-title'>Cadastro de Substâncias</h1>
            <form onSubmit={handleSubmit} className='mt-5 flex w-full flex-1 flex-col gap-y-4'>
                <CardForm title='Informações da Substância' style='grid grid-cols-1 gap-4 lg:grid-cols-2'>
                    <TextField required control={control} name='scientificName' outsideTitle='Nome Científico' />
                    <TextField required control={control} name='popularName' outsideTitle='Nome Vulgar' />
